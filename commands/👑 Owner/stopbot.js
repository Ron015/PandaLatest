...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      return message.reply({content : `**<a:no:921989165242003476> THIS COMMAND IS DISABLED, go to https://dsc.gg/bot-support.invite and <#936086833987731477> to get it restarted!**\n\n\n> **Path:**
\`\`\`yml
${process.cwd()}
\`\`\`
> **Server:**
...
\`\`\``
      ...
      require("child_process").exec(`pm2 stop index.js Panda_${process.cwd().split(require("path").sep).pop()}`, (error, stdout, stderr) => {
        if (error) {
