  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<a:arrow:923076073942564864> **Name**', "```"+json.name+"```", true)
        .addField("<a:arrow:923076073942564864> **Hex**",  "```"+json.hex+"```", true)
        .addField("<a:arrow:923076073942564864> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<a:arrow:923076073942564864> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
