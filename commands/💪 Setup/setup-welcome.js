    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Welcome Setup', 'https://media.discordapp.net/attachments/921624391769546863/935089409030750213/795892606474125334.gif', 'https://dsc.gg/bot-support.invite')
        ...
        switch (optionhandletype) {          
          ...
          case "Direct Welcome Messages":{
            ...
            async function second_layer(){
              ...
              let MenuEmbed = new MessageEmbed()
                .setColor(es.color)
                .setAuthor('DM - Welcome Setup', 'https://media.discordapp.net/attachments/921624391769546863/935089409030750213/795892606474125334.gif', 'https://dsc.gg/bot-support.invite')
                .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-ticket"]["variable2"]))
              //send the menu msg
              let menumsg = await message.reply({embeds: [MenuEmbed], components: [new MessageActionRow().addComponents(Selection)]})
              //Create the collector
