    ...
    try {
      ...
      async function first_layer() {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Ticket Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/incoming-envelope_1f4e8.png', 'https://dsc.gg/bot-support.invite'))
              ...
              mm.channel.awaitMessages({
                ...
                message.reply({
                  ...
                  msg.channel.awaitMessages({
                    ...
                    let button_open = new MessageActionRow().addComponents([new MessageButton().setStyle('SECONDARY').setCustomId('create_a_ticket').setLabel('Create a Ticket').setEmoji("📨")])
