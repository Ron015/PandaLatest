...
module.exports = {
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    if(!user) user = member.user;
        ...
        embeduserinfo.setAuthor(handlemsg(client.la[ls].cmds.info.permissions.from, {usertag: member.user.tag}), member.user.displayAvatarURL({ dynamic: true }), "https://dsc.gg/panda.invite")
