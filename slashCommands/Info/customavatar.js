    ...
    if (customavatar) {
      let embed = new MessageEmbed()
        .setAuthor(handlemsg(client.la[ls].cmds.info.avatar.author, {
          usertag: user.tag
        }), customavatar, "https://dsc.gg/bot-support.invite")
        .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
        .addField("<a:arrow:923076073942564864> PNG", `[\`LINK\`](${customavatar})`, true)
        .addField("<a:arrow:923076073942564864> JPEG", `[\`LINK\`](${customavatar.replace("png", "jpg").replace("gif", "jpg")})`, true)
        .addField("<a:arrow:923076073942564864> WEBP", `[\`LINK\`](${customavatar.replace("png", "webp").replace("gif", "webp")})`, true)
        .setURL(customavatar)
      ...
      let embed = new MessageEmbed()
        ...
        .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
        .addField("<a:arrow:923076073942564864> PNG", `[\`LINK\`](${user.displayAvatarURL({format: "png"})})`, true)
        .addField("<a:arrow:923076073942564864> JPEG", `[\`LINK\`](${user.displayAvatarURL({format: "jpg"})})`, true)
        .addField("<a:arrow:923076073942564864> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
